# -*- encoding: utf-8 -*-
# stub: octopress 3.0.0.rc.34 ruby lib

Gem::Specification.new do |s|
  s.name = "octopress"
  s.version = "3.0.0.rc.34"
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<octopress-ink>, ["~> 1.0.0.rc"])
      ...
      s.add_dependency(%q<octopress-ink>, ["~> 1.0.0.rc"])
